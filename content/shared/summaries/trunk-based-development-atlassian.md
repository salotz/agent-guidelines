...
## Definition
Trunk-based development is a version control practice where developers merge small,
frequent updates directly to a core “trunk” (main) branch.
...
Unless otherwise specified, assume trunk-based development with short-lived branches and heavy use of rebasing.
Treat commits as logical "layers".

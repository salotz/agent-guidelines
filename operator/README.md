...
the human who installs,
configures,
and supervises agent systems —
not for agents to execute as standing work rules.
...
- [Implementing a sandboxed agent CLI](./implementing-sandbox.md) —
  host bring-up of the landrun + opt + PATH wrapper pattern.

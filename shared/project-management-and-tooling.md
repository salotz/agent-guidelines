...
3. When running project tools:
   prefer the project’s documented tooling entrypoint over assuming global PATH or a pre-activated manager in the agent shell.
4. Do not install host tooling without operator confirmation.
5. Do not collapse tool-manager, package-manager,
